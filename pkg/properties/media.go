...
// MarkerSummary property field names (BSON)
const (
	MarkerSummaryName = "name"
	MarkerSummaryCategoryNames = "categoryNames"
	MarkerSummaryEventNames = "eventNames"
...
const (
	...
	VaultMediaForwardedAt = "forwarded_at"
