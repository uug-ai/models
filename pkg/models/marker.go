...
type Marker struct {
	...
	OrganisationId string `json:"organisationId" bson:"organisationId" example:"686a906345c1df594pad69f0" required:"true"` // OrganisationId is used to identify the organisation that owns the marker, retrieved from the user's access token
...
type MarkerMetadata struct {
	Comments *Comment `json:"comments,omitempty" bson:"comments,omitempty" example:"{\"author\":\"Jane Doe\",\"text\":\"Suspicious vehicle\"}"` // Additional comments or description of the marker
