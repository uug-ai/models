...
type State struct {
	Id          string `json:"id" bson:"_id" example:"state-123" required:"true"`                                       // Unique identifier for the state
	Type 	  string `json:"type" bson:"type" example:"default" required:"true"`                                       // Type of the state, e.g., "default", "alert", "group"
	...
	Active         bool  `json:"active" bson:"active" example:"true" required:"true"`                       // Indicates if the state is currently active
