...
type AnalyticsCount struct {
	...
	// ProjectId optionally places the count in a project within its organisation.
	// A nil value keeps the count organisation-wide.
...
type Heatmap struct {
	...
	// ProjectId optionally places the heatmap in a project within its organisation.
	// A nil value keeps the heatmap organisation-wide.
	ProjectId *primitive.ObjectID `json:"projectId,omitempty" bson:"projectId,omitempty"`
